        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li ><a href="/xindex_en.html">Home</a></li>
                    <li><a href="servicos_en.html">Services</a></li>
                    <li ><a href="empresa_en.html">JCP - Company</a></li> 
                    <li class="active"><a href="contato_en.asp">Contact</a></li> 
                </ul>
            </div>
        </div>
    </div>
   ...
   <div class="row">	
	...
	<div class="col-sm-offset-3 col-sm-6">
	   <!-- Form itself -->
		 ...
		 <div class="control-group">
			...
			<input type="text" class="form-control" 
			   	   placeholder="Full Name" id="name" name="name" required
			           data-validation-required-message="type your full name" />
			...
			<input type="email" class="form-control" placeholder="Email" 
			   		   ...
			   		   data-validation-required-message="Type your e-mail" />
		</div>
	    </div> 	
	     ...
	     <div id="success"><% if resposta <> "" then Response.Write "<b><<Message successfully sent!  >></b>" %>  </div> <!-- For success/fail messages -->
